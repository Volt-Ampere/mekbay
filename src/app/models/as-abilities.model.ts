...
export interface ASSpecialAbility {
    tag: string | string[];
    name: string;
...
export const AS_SPECIAL_ABILITIES: ASSpecialAbility[] = [
    {
        tag: "AFC",
    ...
    },
    {
        ...
        summary: [
            ...
            "Each different type of artillery a unit carries is listed separately, with the number indicating the number of that type carried. For example, a unit with two Long Tom artillery weapons would record this as ARTLT-2.",
            "Refer to the Artillery Range and Damage Table, page 47 (see the Bomb (BOMB#) special ability, p. 77, for Arrow IV missiles carried as bombs)."
        ],
        rulesBook: Rulebook.ASCE,
        rulesPage: 82,
        type: SpecialAbilityType.Optional
    ...
    // base BHJ in in the standard abilities
    {
        tag: "BHJ2",
    ...
    },
    {
        ...
        summary: [
            "A unit with this special ability can dock with the indicated number of DropShip units (see Docking/Undocking, p. 87). A Dock Hit critical hit to a unit with this ability will reduce its docking capacity by 1, to a minimum of 0."
        ],
        rulesBook: Rulebook.ASC,
        rulesPage: 89,
        type: SpecialAbilityType.Standard
    ...
    {
        tag: "KF",
        name: "Kearny-Fuchida Drive",
        summary: [
            "A unit with this special ability can execute hyperspace jumps (see Hyperspace Jumps, p. 88)."
        ],
        rulesBook: Rulebook.ASC,
        rulesPage: 89,
        type: SpecialAbilityType.Standard
    ...
    {
        tag: "LF",
        name: "Lithium-Fusion Battery",
        summary: [
            "A unit with this special ability is capable of storing a charge for a second hyperspace jump immediately after one has already been attempted (see Hyperspace Jumps, p. 88). Without this special ability, a KF-equipped unit can only attempt one jump per scenario."
        ],
        rulesBook: Rulebook.ASC,
        rulesPage: 89,
        type: SpecialAbilityType.Standard
    ...
    {
        tag: "SCR#",
        name: "Screen Launchers",
        summary: [
            "This special ability enables a unit to deploy clouds obscuring chaff in space designed to impair weapons fire. In capital-scale abstract aerospace play, this ability, when used, can apply a +1 to-hit modifier (to a maximum of +4) to all weapon attacks against (and by) the SCR-equipped unit per point of Screen Launchers indicated by the special ability. For instance, if a unit has a SCR3 special, attacks against it will apply a +3 to-hit modifier if the controlling unit decides to use its screens, while a unit with the SCR6 special cannot apply more than a +4 to-hit modifier.",
            "Any unit that uses its screen launchers reduces a unit’s available attacks in that turn by 1."
        ],
        rulesBook: Rulebook.ASC,
        rulesPage: 89,
        type: SpecialAbilityType.Standard
    },
    {
        ...
        name: "Spaceflight-Capable",
        summary: [
            "In order to operate in any sector on the Capital Radar Map (or on the Outer Ring of an atmospheric Radar Map), a unit must possess this special ability, which represents the life-support, thrusters, and all other equipment needed to function outside of a planetary atmosphere. Aerospace fighters, Small Craft, DropShips, JumpShips, satellites, space stations, and WarShips all possess this ability by default."
        ],
        rulesBook: Rulebook.ASC,
        rulesPage: 89,
        type: SpecialAbilityType.Standard
    ...
    {
        tag: "TELE",
        name: "Teleoperated Missiles",
        summary: [
            "Units with this special ability apply a –1 to-hit modifier for all attacks made using capital missiles, including those made using the Advanced Capital Missile Attack and High-Speed Attack rules."
        ],
        rulesBook: Rulebook.ASC,
        rulesPage: 89,
        type: SpecialAbilityType.Standard
